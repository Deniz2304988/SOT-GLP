...
from sot_glp.models.prompted_transformers import PromptedTransformer
from sot_glp.models.clip_local import ModifiedResNet, VisionTransformer, CLIP
...
class SOTGLP(CLIP):
    ...
    def __init__(
        ...
        self.model_name = "sotglp_" + clip_name[5:]
