...
if __name__ == "__main__":
    ...
    for epoch in range(args.max_epoch):
        ...
        if ((epoch % args.eval_freq == 0) and (epoch > 0)) or (epoch + 1 == args.max_epoch) or args.eval_only:
            ...
            val_meter, test_scores = evaluate(model, val_loader, train_loader.dataset.all_names, args, return_scores=args.eval_ood and (args.eval_only or (epoch + 1 == args.max_epoch)))
